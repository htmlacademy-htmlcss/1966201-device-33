...
if(document.querySelector(".rare-item__link")) {
    document.querySelector(".rare-item__link").addEventListener("click", function(evt){
        evt.preventDefault();
        document.querySelector(".modal-container").classList.add("modal-container--show");
    });
    
    document.querySelector(".modal-close-button").addEventListener("click", function(evt){
        evt.preventDefault();
        document.querySelector(".modal-container").classList.remove("modal-container--show");
    });
